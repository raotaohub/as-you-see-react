...
var isHydratableResource = $$$hostConfig.isHydratableResource;
var getMatchingResourceInstance = $$$hostConfig.getMatchingResourceInstance;
...
function getPreviouslyUsedThenableAtIndex(index) {
  if (usedThenables !== null) {
    var thenable = usedThenables[index];
...
var thenableIndexCounter = 0; // Used for ids that are generated completely client-side (i.e. not during
...

{
  ...
  {
    HooksDispatcherOnMountWithHookTypesInDEV.useEvent = function useEvent(callback) {
      currentHookNameInDev = 'useEvent';
      updateHookTypesDev();
      return mountEvent(callback);
    };
  ...
  {
    InvalidNestedHooksDispatcherOnMountInDEV.useEvent = function useEvent(callback) {
      currentHookNameInDev = 'useEvent';
      warnInvalidHookAccess();
      mountHookTypesDev();
      return mountEvent(callback);
  ...
  {
    InvalidNestedHooksDispatcherOnUpdateInDEV.useEvent = function useEvent(callback) {
      currentHookNameInDev = 'useEvent';
      warnInvalidHookAccess();
      updateHookTypesDev();
      return updateEvent(callback);
  ...
  {
    InvalidNestedHooksDispatcherOnRerenderInDEV.useEvent = function useEvent(callback) {
      currentHookNameInDev = 'useEvent';
      warnInvalidHookAccess();
      updateHookTypesDev();
      return updateEvent(callback);
...
function doubleInvokeEffectsInDEV(root, fiber, parentIsInStrictMode) {
  ...
  if (fiber.flags & PlacementDEV || fiber.tag === OffscreenComponent) {
    setCurrentFiber(fiber);
    var isNotOffscreen = fiber.tag !== OffscreenComponent; // Checks if Offscreen is being revealed. For all other components, evaluates to true.

    var hasOffscreenBecomeVisible = isNotOffscreen || fiber.flags & Visibility && fiber.memoizedState === null;
...
//# sourceMappingURL=react-reconciler.development.js.map
