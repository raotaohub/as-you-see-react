(function (global, factory) {
  ...
  function getEventKey(nativeEvent) {
    if (nativeEvent.key) {
      ...
      const key = // $FlowFixMe unable to index with a `mixed` value
    ...
    if (nativeEvent.type === 'keypress') {
      const charCode = getEventCharCode( // $FlowFixMe unable to narrow to `KeyboardEvent`
  ...
  function extractEvents$2(dispatchQueue, domEventName, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags, targetContainer) {
    ...
    const toNode = to == null ? win : getNodeFromInstance(to); // $FlowFixMe[prop-missing]
    // $FlowFixMe[incompatible-type]
        ...
        case 'link':
          {
            ...
            const selector = "link[rel=\"stylesheet\"][data-rprec][href=\"" + props.href + "\"]";
            const link = getOwnerDocumentFromRootContainer(rootHostContainer).querySelector(selector);
